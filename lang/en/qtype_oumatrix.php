...
$string['columnshdr'] = 'OUMatrix columns (answers)';
...
$string['pluginname_help'] = 'Creating an OUMatrix question requires you to specify column headings (answers) and row headings (sub-questions). For example, you might use Single Choice mode to ask students to categorise various sub-question items as being either an animal, vegetable, or mineral. You can use the Multiple Response mode where several answers may apply to a sub-question, e.g. if the item is a conductor, insulator, and/or magnetic.';
$string['pluginnameadding'] = 'Adding an OUMatrix question';
$string['pluginnameediting'] = 'Editing an OUMatrix question';
