...
$string['columnshdr'] = 'OU matrix columns (answers)';
...
$string['pluginname'] = 'OU matrix';
$string['pluginname_help'] = 'Creating an OU matrix question requires you to specify column headings (answers) and row headings (sub-questions). For example, you might use Single Choice mode to ask students to categorise various sub-question items as being either an animal, vegetable, or mineral. You can use the Multiple Response mode where several answers may apply to a sub-question, e.g. if the item is a conductor, insulator, and/or magnetic.';
$string['pluginnameadding'] = 'Adding an OU matrix question';
$string['pluginnameediting'] = 'Editing an OU matrix question';
$string['pluginnamesummary'] = 'A multi-row table that can use single choice or multiple response inputs.';
$string['privacy:metadata'] = 'OU matrix question type plugin allows question authors to set default options as user preferences.';
...
$string['rowshdr'] = 'OU matrix rows (sub-questions)';
$string['rowx'] = 'Row{$a})';
...
$string['shuffleanswers_help'] = 'The order of the row and/or column items will be randomly shuffled for each attempt, provided that "Shuffle within questions" in the activity settings is also enabled.';
$string['shuffleanswers_optioncolumnonly'] = 'Columns only';
$string['shuffleanswers_optionrowcolumn'] = 'Rows and columns';
$string['shuffleanswers_optionrowonly'] = 'Rows only';
