...
class question_single_test extends \advanced_testcase {
    ...
    public function test_classify_response_single(): void {
        ...
        $this->assertEquals([
                11 => new question_classified_response(11, 'Insects', 1),
                12 => new question_classified_response(12, 'Fish',  1),
                13 => new question_classified_response(13, 'Birds', 1),
                14 => new question_classified_response(14, 'Mammals', 1),
        ...
        $this->assertEquals([
                11 => new question_classified_response(11, 'Insects', 1),
                12 => new question_classified_response(13, 'Birds', 0),
                13 => new question_classified_response(13, 'Birds', 1),
                14 => new question_classified_response(14, 'Mammals', 1),
        ], $question->classify_response($response));
        ...
        $this->assertEquals([
                ...
                12 => new question_classified_response(13, 'Birds', 0),
                13 => new question_classified_response(13, 'Birds', 1),
                14 => new question_classified_response(11, 'Insects', 0),
        ], $question->classify_response($response));
        ...
        $this->assertEquals([
                11 => new question_classified_response(11, 'Insects', 1),
                12 => question_classified_response::no_response(),
                13 => new question_classified_response(13, 'Birds', 1),
                14 => new question_classified_response(11, 'Insects', 0),
        ], $question->classify_response($response));
    }
